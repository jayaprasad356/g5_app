package com.gmwapp.slv_g5.activities;
...
//        String url = "https://api.whatsapp.com/send?phone="+"91"+session.getData(Constant.WHATSAPP);
    ...
    private void Login() {
        ...
        params.put(com.gmwapp.slv_g5.helper.Constant.MOBILE, Mobile);
        params.put(com.gmwapp.slv_g5.helper.Constant.PASSWORD, Password);
        params.put(com.gmwapp.slv_g5.helper.Constant.DEVICE_ID, com.gmwapp.slv_g5.helper.Constant.getDeviceId(activity));

        ApiConfig.RequestToVolley((result, response) -> {
            if (result) {
                try {
                    JSONObject jsonObject = new JSONObject(response);
                    if (jsonObject.getBoolean(com.gmwapp.slv_g5.helper.Constant.SUCCESS)) {
                        String codegenerate = "0", withdrawal_status = "0";
                        if (jsonObject.getBoolean(com.gmwapp.slv_g5.helper.Constant.USER_VERIFY)) {

                            JSONArray userArray = jsonObject.getJSONArray(com.gmwapp.slv_g5.helper.Constant.DATA);
                            JSONArray setArray = jsonObject.getJSONArray(com.gmwapp.slv_g5.helper.Constant.SETTINGS);

                            JSONObject settings = setArray.getJSONObject(0);
//                                session.setData(com.gmwapp.slv_g5.helper.Constant.SYNC_TIME, settings.getString(com.gmwapp.slv_g5.helper.Constant.SYNC_TIME));

                            if (settings.getString(com.gmwapp.slv_g5.helper.Constant.CODE_GENERATE).equals("1")) {
                                codegenerate = userArray.getJSONObject(0).getString(com.gmwapp.slv_g5.helper.Constant.CODE_GENERATE);
                            }
                            if (settings.getString(com.gmwapp.slv_g5.helper.Constant.WITHDRAWAL_STATUS).equals("1")) {
                                withdrawal_status = userArray.getJSONObject(0).getString(com.gmwapp.slv_g5.helper.Constant.WITHDRAWAL_STATUS);
                            }

                            Toast.makeText(this, jsonObject.getString(com.gmwapp.slv_g5.helper.Constant.MESSAGE), Toast.LENGTH_SHORT).show();

                            JSONObject userData = userArray.getJSONObject(0);
                            session.setData(com.gmwapp.slv_g5.helper.Constant.USER_ID, userData.getString(com.gmwapp.slv_g5.helper.Constant.ID));

                            if (session.getBoolean(com.gmwapp.slv_g5.helper.Constant.IMPORT_DATA)) {
...
//                            if (jsonObject.getBoolean(com.gmwapp.slv_g5.helper.Constant.DEVICE_VERIFY)) {
//                                String codegenerate = "0", withdrawal_status = "0";
//                                JSONArray userArray = jsonObject.getJSONArray(com.gmwapp.slv_g5.helper.Constant.DATA);
//                                JSONArray setArray = jsonObject.getJSONArray(com.gmwapp.slv_g5.helper.Constant.SETTINGS);
//
...
//                            }
                            ...
                            ApprovalAlertdialog(jsonObject.getString(com.gmwapp.slv_g5.helper.Constant.MESSAGE));
                        }
                    } else {
                        Toast.makeText(this, jsonObject.getString(com.gmwapp.slv_g5.helper.Constant.MESSAGE), Toast.LENGTH_SHORT).show();
                    }
        ...
        }, LoginActivity.this, com.gmwapp.slv_g5.helper.Constant.LOGIN_URL, params, true);

        Log.d("LOGIN_URL", "LOGIN_URL: " + com.gmwapp.slv_g5.helper.Constant.LOGIN_URL);
