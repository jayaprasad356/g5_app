...
import com.gmwapp.slv_g5.Adapter.ReferTargetAdapter;
...
import com.gmwapp.slv_g5.model.RefersTargetModel;
        ...
        ApiConfig.RequestToVolley((result, response) -> {
            if (result) {
                try {
                    ...
                    String message = jsonObject.getString(com.gmwapp.slv_g5.helper.Constant.MESSAGE);
